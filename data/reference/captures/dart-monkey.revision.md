...
Placement costs 200 Gold. Dart Throw is an automatic projectile attack. Every 0.95 s it fires 1 projectile at its target; each deals 1 Sharp damage with pierce 2, hitting up to 2 enemies, at range 32. Sharp damage cannot hurt Lead and Frozen enemies.
...
**x-x-5 Crossbow Master** (21,500 Gold). Shortens the attack interval from 0.475 s to 0.2375 s (×0.5). Raises range from 60 to 80 (+20). Raises pierce from 4 to 8 (+4). Switches damage from Sharp to Normal. Normal damage can hurt every enemy property.
...
| 1-4-0 | 8,280 Gold | 1-x-x: pierce 2 → 3, during Super Monkey Surge: pierce 2 → 3 | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 3, range 32. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 1 Sharp damage, pierce 3, range 32 |
| 2-4-0 | 8,480 Gold | 1-x-x and 2-x-x: pierce 2 → 5, during Super Monkey Surge: pierce 2 → 5 | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 5, range 32. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 1 Sharp damage, pierce 5, range 32 |
| 0-4-1 | 8,230 Gold | x-x-1: range 32 → 40, during Super Monkey Surge: range 32 → 40 | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 2, range 40. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 1 Sharp damage, pierce 2, range 40 |
| 0-4-2 | 8,430 Gold | x-x-1 and x-x-2: range 32 → 48, detects Camo, during Super Monkey Surge: range 32 → 48, detects Camo | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 2, range 48; detects Camo. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 1 Sharp damage, pierce 2, range 48; detects Camo |
| 1-5-0 | 53,280 Gold | 1-x-x: pierce 5 → 6, during Super Monkey Surge: pierce 5 → 6 | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 6, range 32. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 2 Sharp damage, pierce 6, range 32 |
| 2-5-0 | 53,480 Gold | 1-x-x and 2-x-x: pierce 5 → 8, during Super Monkey Surge: pierce 5 → 8 | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 8, range 32. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 2 Sharp damage, pierce 8, range 32 |
| 0-5-1 | 53,230 Gold | x-x-1: range 32 → 40, during Super Monkey Surge: range 32 → 40 | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 5, range 40. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 2 Sharp damage, pierce 5, range 40 |
| 0-5-2 | 53,430 Gold | x-x-1 and x-x-2: range 32 → 48, detects Camo, during Super Monkey Surge: range 32 → 48, detects Camo | 3 projectiles every 0.2392 s, 1 Sharp damage, pierce 5, range 48; detects Camo. Active Ability: Super Monkey Surge for 15 s every 50 s: 3 projectiles every 0.015 s, 2 Sharp damage, pierce 5, range 48; detects Camo |
...
| 1-0-5 | 24,755 Gold | 1-x-x: pierce 8 → 9 | 1 projectile every 0.2375 s, 6 Normal damage, pierce 9, range 80; detects Camo |
| 2-0-5 | 24,955 Gold | 1-x-x and 2-x-x: pierce 8 → 11 | 1 projectile every 0.2375 s, 6 Normal damage, pierce 11, range 80; detects Camo |
| 0-1-5 | 24,715 Gold | x-1-x: interval 0.2375 s → 0.2019 s | 1 projectile every 0.2019 s, 6 Normal damage, pierce 8, range 80; detects Camo |
| 0-2-5 | 24,905 Gold | x-1-x and x-2-x: interval 0.2375 s → 0.1595 s | 1 projectile every 0.1595 s, 6 Normal damage, pierce 8, range 80; detects Camo |

## Patch notes

### Mechanics

- x-4-x price 6,000 Gold to 7,200 Gold.
- x-5-x price 25,000 Gold to 45,000 Gold.
- x-x-5 price 16,000 Gold to 21,500 Gold.
- x-x-5 now: Shortens the attack interval from 0.475 s to 0.2375 s (×0.5). Raises range from 60 to 80 (+20). Raises pierce from 4 to 8 (+4). Switches damage from Sharp to Normal. Normal damage can hurt every enemy property. Before: Raises damage from 6 to 8 (+2). Shortens the attack interval from 0.475 s to 0.2375 s (×0.5). Raises range from 60 to 80 (+20). Switches damage from Sharp to Normal. Normal damage can hurt every enemy property.

Resolved differently: 5 legal builds (0-0-5, 0-1-5, 0-2-5, 1-0-5, 2-0-5).
