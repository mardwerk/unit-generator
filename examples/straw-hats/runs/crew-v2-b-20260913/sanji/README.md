...
| 2 | Reinforced Kicks | 550 | Ignores 15% of armor on ordinary contact damage. Reaching tier 2 also unlocks stamina, Mouton Shot, Diable Jambe and Flambage Shot, regardless of path. | `{"armorIgnore":0.15}` |
| 3 | Heavy Impact | 1100 | Multiplies primary and Technique contact damage by 1.25. | `{"damageMultiplier":1.25}` |
| 4 | Armament-Reinforced Leg | 2200 | Raises purchased armor ignore to 35%. Highest tier 4 unlocks Anti-Manner Kick Course and Spectre in their respective forms. | `{"armorIgnore":0.35}` |
