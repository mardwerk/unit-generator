...
| 3 | Restorative Soup | 400 | Raises healing to 18 per ally. Inspired by soup restoring energy and strength, with injury healing explicitly a game abstraction. | `{"support":{"name":"Restorative Soup Service","interval":8,"radius":18,"cap":3,"heal":18}}` |
