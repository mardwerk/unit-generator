...
Personal impact and armor pressure grounded in Black Leg strength and Armament reinforcement. Armor ignore is a bounded game interpretation, not advanced internal-destruction Haki.
...
| 2 | Reinforced Kicks | 550 | Ignores 15% of armor on ordinary contact damage. | `{"armorIgnore":0.15}` |
| 3 | Heavy Impact | 1100 | Multiplies primary and Technique contact damage by 1.25. | `{"damageMultiplier":1.25}` |
| 4 | Armament-Reinforced Leg | 2200 | Raises purchased armor ignore to 35%. | `{"armorIgnore":0.35}` |
| 5 | Awakened Kicking Strength | 4800 | Multiplies primary and Technique contact damage by another 1.4. | `{"damageMultiplier":1.4}` |

### Speed and Observation

Fast kicks, acrobatic contact coverage and presence sensing.
...
| 3 | Acrobatic Kick Coverage | 950 | Adds 4 reach to the active contact profile, including its contextual Techniques. | `{"reachAdd":4}` |
...
| 5 | Wano Burst Speed | 4200 | Multiplies primary timing by another 0.75. | `{"primaryTimingMultiplier":0.75}` |
...
| Tier | Upgrade | Cost | Description | Executable modifiers |
| ---: | --- | ---: | --- | --- |
| 1 | Hot Meal | 125 | Every 8 seconds, heals up to 2 eligible allies within 14 units for 10 each. | `{"support":{"name":"Hot Meal Service","interval":8,"radius":14,"cap":2,"heal":10}}` |
| 2 | Extra Portions | 200 | Expands meal service to 3 allies within 18 units; keeps 10 healing and the 8-second interval. | `{"support":{"name":"Extra Portion Service","interval":8,"radius":18,"cap":3,"heal":10}}` |
| 3 | Restorative Soup | 400 | Raises healing to 18 per ally. Injury healing is a game abstraction. | `{"support":{"name":"Restorative Soup Service","interval":8,"radius":18,"cap":3,"heal":18}}` |
| 4 | Rapid Kitchen Service | 700 | Shortens meal interval to 6 seconds while retaining radius 18, cap 3 and healing 18. | `{"support":{"name":"Rapid Meal Service","interval":6,"radius":18,"cap":3,"heal":18}}` |
| 5 | Crew Banquet | 1400 | Serves up to 5 eligible allies for 26 healing each every 6 seconds within 18 units. No ally damage buff. | `{"support":{"name":"Crew Banquet Service","interval":6,"radius":18,"cap":5,"heal":26}}` |
