# Standalone authoring (deferred)

Original-character authoring — inventing a character and writing explicit game rules for it — is a deferred goal. It is not something this project does in the near term.
